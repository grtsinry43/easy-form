...
import Rating from '@/components/materials/advanced/rating.vue'
...
import MaxEditor from '@/components/edit-items/max-editor.vue'
...
export type RatingValue = {
  ...
  max: ComponentProperty & { value: string[]; currentValue: number }
...
export default function () {
  ...
  return {
    ...
    value: {
      ...
      max: {
        ...
        isShow: true,
        type: 'max-editor',
        editComponent: markRaw(MaxEditor),
      },
      position: {
        id: uuidV4(),
        currentValue: 0,
  ...
  } as BaseComponentType<RatingValue>
}
