...
import ImageMultiple from '@/components/materials/select/image-multiple.vue'
...
export type ImageMultipleValue = {
...
export default function () {
  ...
  return {
    id: uuidV4(),
    component: markRaw(ImageMultiple),
    type: 'image-multiple',
    value: {
      title: {
        id: uuidV4(),
  ...
  } as BaseComponentType<ImageMultipleValue>
}
