...
import Time from '@/components/materials/advanced/time.vue'
...
import FormatEditor from '@/components/edit-items/format-editor.vue'
...
export type TimeValue = {
  ...
  format: ComponentProperty & { value: string }
...
export default function () {
  ...
  return {
    ...
    value: {
      ...
      format: {
        ...
        isShow: true,
        type: 'format-editor',
        editComponent: markRaw(FormatEditor),
      },
      position: {
        id: uuidV4(),
        currentValue: 0,
  ...
  } as BaseComponentType<TimeValue>
}
